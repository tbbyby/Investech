...
-- 插入测试用户
INSERT INTO user (username, password, email, phone, real_name, status, create_time, update_time) VALUES
...
-- 插入测试基金
INSERT INTO fund (fund_code, fund_name, fund_type, fund_company, fund_manager, net_value, net_value_date, total_assets, daily_return, weekly_return, monthly_return, yearly_return, max_drawdown, sharpe_ratio, risk_level, tags, status, create_time, update_time) VALUES
...
-- 插入测试因子
INSERT INTO factor (factor_code, factor_name, factor_desc, factor_type, data_source, calculation_method, unit, category, parent_code, level, sort_order, status, create_time, update_time) VALUES
...
-- 插入测试基金组合
INSERT INTO fund_portfolio (portfolio_name, portfolio_desc, user_id, fund_codes, weights, status, create_time, update_time) VALUES
